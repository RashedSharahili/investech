                    ...
                    <div className="mx-auto">
                        <div className="flex justify-center items-center h-screen" style={{ backgroundImage: `url(${HeroLines.src})`, backgroundPosition: "center", backgroundSize: "cover" }}>
                            <div className={`mt-12 lg:mt-0 md:mt-24 sm:mt-24 xs:mt-24`}>
                                <h1 className={`text-3xl text-system-cyan mb-10 flex justify-center`}>تسجيل الدخول</h1>

                                <div
                                    className="block w-full rounded-lg p-6 dark:bg-neutral-700">
                                    <form>
                                        {/* <!--E-mail input--> */}
